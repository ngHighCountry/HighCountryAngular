...
to support other programming langulage syntax helight for PrismJs you need to add them to your project.
...
```html
<div Markdown [data]="'### your markdown code'"></div>

<!-- or use angular component -->

<ngx-md [data]="' ### your markdown code'"></ngx-md>
...
Marked can be customized/extended by accessing the renderer from the NgxMdService:
...
```shell
  npm i ngx-md@latest --save
```

With Angular 6 update we udated our packages also. 

instead of `MarkdownModule` use `NgxMdModule`.
